...
| RPA + static LFC | valid | classical_maxwellian | benchmark_dense | 0.077 | 7 | 4.502 | 5.365 |
| Mermin + static LFC | valid | classical_maxwellian | benchmark_dense | 0.070 | 7 | 4.503 | 5.366 |
| Auto best per state | valid | classical_maxwellian | benchmark_dense | 0.088 | 7 | 4.503 | 5.366 |
...
| RPA | valid | classical_maxwellian | benchmark_dense | 0.140 | 7 | 6.480 | 7.505 |
| Mermin | valid | classical_maxwellian | benchmark_dense | 0.141 | 7 | 6.482 | 7.506 |
...
| Mermin + static LFC | valid | classical_maxwellian | benchmark_dense | 0.008 | 5 | 2.249 | 2.833 |
| Auto best per state | valid | classical_maxwellian | benchmark_dense | 0.009 | 5 | 2.249 | 2.833 |
| RPA | valid | classical_maxwellian | benchmark_dense | 0.286 | 5 | 3.652 | 4.637 |
| Mermin | valid | classical_maxwellian | benchmark_dense | 0.282 | 5 | 3.660 | 4.660 |
| Finite-T Lindhard | valid | finite_t_lindhard | benchmark_dense | 0.442 | 5 | 6.892 | 7.301 |
| Finite-T Lindhard + Mermin | valid | finite_t_lindhard | benchmark_dense | 0.380 | 5 | 7.519 | 8.345 |
| Finite-T Lindhard + static LFC | valid | finite_t_lindhard | benchmark_dense | 0.005 | 5 | 7.819 | 8.179 |
| Finite-T Lindhard + Mermin + static LFC | valid | finite_t_lindhard | benchmark_dense | 0.007 | 5 | 8.267 | 8.883 |
...
- `outputs\validation_outputs\plasmon_article_cases_response_shape_experiment\electron_column_weighted_control\all_model_results.json`
- `outputs\validation_outputs\plasmon_article_cases_response_shape_experiment\electron_column_weighted_control\benchmark_points.csv`
- `outputs\validation_outputs\plasmon_article_cases_response_shape_experiment\electron_column_weighted_control\benchmark_summary.csv`
- `outputs\validation_outputs\plasmon_article_cases_response_shape_experiment\electron_column_weighted_control\policy_state_summary.csv`
- `outputs\validation_outputs\plasmon_article_cases_response_shape_experiment\electron_column_weighted_control\policy_sensitivity_summary.csv`
- `outputs\validation_outputs\plasmon_article_cases_response_shape_experiment\electron_column_weighted_control\reconciliation_summary.csv`
- `outputs\validation_outputs\plasmon_article_cases_response_shape_experiment\electron_column_weighted_control\driven_policy_table.csv`
- `outputs\validation_outputs\plasmon_article_cases_response_shape_experiment\electron_column_weighted_control\driven_state_comparison.csv`
- `outputs\validation_outputs\plasmon_article_cases_response_shape_experiment\electron_column_weighted_control\driven_branch_reconciliation_delta.csv`
- `outputs\validation_outputs\plasmon_article_cases_response_shape_experiment\electron_column_weighted_control\ambient_dataset_overlay.png`
- `outputs\validation_outputs\plasmon_article_cases_response_shape_experiment\electron_column_weighted_control\driven_legacy_hydro_overlay.png`
- `outputs\validation_outputs\plasmon_article_cases_response_shape_experiment\electron_column_weighted_control\driven_best_hydro_overlay.png`
- `outputs\validation_outputs\plasmon_article_cases_response_shape_experiment\electron_column_weighted_control\driven_dataset_overlay.png`
- `outputs\validation_outputs\plasmon_article_cases_response_shape_experiment\electron_column_weighted_control\ambient_representative_spectra.png`
- `outputs\validation_outputs\plasmon_article_cases_response_shape_experiment\electron_column_weighted_control\driven_representative_spectra.png`