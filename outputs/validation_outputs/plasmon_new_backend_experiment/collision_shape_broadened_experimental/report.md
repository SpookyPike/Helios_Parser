...
- classical response cache stats: **{'finite_t_susceptibility_hits': 4536, 'finite_t_susceptibility_misses': 6624, 'finite_t_susceptibility_currsize': 512, 'finite_t_susceptibility_maxsize': 512}**
...
| Quantum hydrodynamic (experimental) | 5.800 | 6.688 | 5.800 | 5.800 | 0.888 |
...
| Quantum hydrodynamic (experimental) | rpa | Article Al + driven increment | legacy_dense_slab -> article_density_average_fixed_temperature | - | 2.275 | not_comparable |
...
| Quantum hydrodynamic (experimental) -> rpa | 2.400 | 2.433 | 2.462 | 2.275 |
...
|---|---|---|---|---:|---:|---:|---:|
| Finite-T Lindhard | valid | finite_t_lindhard | benchmark_dense | 0.163 | 7 | 3.485 | 3.765 |
| Quantum hydrodynamic (experimental) | valid | quantum_hydrodynamic | benchmark_dense | 0.060 | 7 | 3.950 | 5.865 |
| RPA + static LFC | valid | classical_maxwellian | benchmark_dense | 0.062 | 7 | 4.502 | 5.365 |
| Mermin + static LFC | valid | classical_maxwellian | benchmark_dense | 0.063 | 7 | 4.503 | 5.366 |
| Auto best per state | valid | classical_maxwellian | benchmark_dense | 0.071 | 7 | 4.503 | 5.366 |
| Finite-T Lindhard + Mermin | valid | finite_t_lindhard | benchmark_dense | 0.152 | 7 | 4.647 | 5.348 |
...
| Mermin | valid | classical_maxwellian | benchmark_dense | 0.127 | 7 | 6.482 | 7.506 |
| Quick look | not_applicable | classical_maxwellian | benchmark_dense | 0.048 | 7 | 6.528 | 7.560 |
| Finite-T Lindhard + Mermin + static LFC | valid | finite_t_lindhard | benchmark_dense | 0.062 | 7 | 7.215 | 8.866 |

### Driven article-reconciled state vs experiment

| model | status | backend | collision | runtime mean [s] | valid points | MAE [eV] | RMSE [eV] |
|---|---|---|---|---:|---:|---:|---:|
| RPA + static LFC | valid | classical_maxwellian | benchmark_dense | 0.009 | 5 | 2.290 | 2.870 |
| Mermin + static LFC | valid | classical_maxwellian | benchmark_dense | 0.010 | 5 | 2.295 | 2.879 |
| Auto best per state | valid | classical_maxwellian | benchmark_dense | 0.014 | 5 | 2.295 | 2.879 |
| RPA | valid | classical_maxwellian | benchmark_dense | 0.269 | 5 | 3.694 | 4.698 |
| Mermin | valid | classical_maxwellian | benchmark_dense | 0.307 | 5 | 3.704 | 4.722 |
| Quantum hydrodynamic (experimental) | valid | quantum_hydrodynamic | benchmark_dense | 0.011 | 5 | 6.688 | 7.781 |
| Finite-T Lindhard | valid | finite_t_lindhard | benchmark_dense | 0.373 | 5 | 6.791 | 7.213 |
| Finite-T Lindhard + Mermin | valid | finite_t_lindhard | benchmark_dense | 0.399 | 5 | 7.437 | 8.290 |
| Finite-T Lindhard + static LFC | valid | finite_t_lindhard | benchmark_dense | 0.006 | 5 | 7.699 | 8.060 |
| Finite-T Lindhard + Mermin + static LFC | valid | finite_t_lindhard | benchmark_dense | 0.007 | 5 | 8.184 | 8.822 |
...
- `C:\Users\dimab\Documents\Helios_parser\outputs\validation_outputs\plasmon_new_backend_experiment\collision_shape_broadened_experimental\all_model_results.json`
- `C:\Users\dimab\Documents\Helios_parser\outputs\validation_outputs\plasmon_new_backend_experiment\collision_shape_broadened_experimental\benchmark_points.csv`
- `C:\Users\dimab\Documents\Helios_parser\outputs\validation_outputs\plasmon_new_backend_experiment\collision_shape_broadened_experimental\benchmark_summary.csv`
- `C:\Users\dimab\Documents\Helios_parser\outputs\validation_outputs\plasmon_new_backend_experiment\collision_shape_broadened_experimental\policy_state_summary.csv`
- `C:\Users\dimab\Documents\Helios_parser\outputs\validation_outputs\plasmon_new_backend_experiment\collision_shape_broadened_experimental\policy_sensitivity_summary.csv`
- `C:\Users\dimab\Documents\Helios_parser\outputs\validation_outputs\plasmon_new_backend_experiment\collision_shape_broadened_experimental\reconciliation_summary.csv`
- `C:\Users\dimab\Documents\Helios_parser\outputs\validation_outputs\plasmon_new_backend_experiment\collision_shape_broadened_experimental\driven_policy_table.csv`
- `C:\Users\dimab\Documents\Helios_parser\outputs\validation_outputs\plasmon_new_backend_experiment\collision_shape_broadened_experimental\driven_state_comparison.csv`
- `C:\Users\dimab\Documents\Helios_parser\outputs\validation_outputs\plasmon_new_backend_experiment\collision_shape_broadened_experimental\driven_branch_reconciliation_delta.csv`
- `C:\Users\dimab\Documents\Helios_parser\outputs\validation_outputs\plasmon_new_backend_experiment\collision_shape_broadened_experimental\ambient_dataset_overlay.png`
- `C:\Users\dimab\Documents\Helios_parser\outputs\validation_outputs\plasmon_new_backend_experiment\collision_shape_broadened_experimental\driven_legacy_hydro_overlay.png`
- `C:\Users\dimab\Documents\Helios_parser\outputs\validation_outputs\plasmon_new_backend_experiment\collision_shape_broadened_experimental\driven_best_hydro_overlay.png`
- `C:\Users\dimab\Documents\Helios_parser\outputs\validation_outputs\plasmon_new_backend_experiment\collision_shape_broadened_experimental\driven_dataset_overlay.png`
- `C:\Users\dimab\Documents\Helios_parser\outputs\validation_outputs\plasmon_new_backend_experiment\collision_shape_broadened_experimental\ambient_representative_spectra.png`
- `C:\Users\dimab\Documents\Helios_parser\outputs\validation_outputs\plasmon_new_backend_experiment\collision_shape_broadened_experimental\driven_representative_spectra.png`