...
- driven response model: **No driven response correction (none)**
...
- classical response cache stats: **{'finite_t_susceptibility_hits': 1179, 'finite_t_susceptibility_misses': 1611, 'finite_t_susceptibility_currsize': 512, 'finite_t_susceptibility_maxsize': 512}**
...
- weighted ne: **2.7620e+23 cm^-3**
- weighted Zbar: **3**
- raw vs effective ne: **2.7620e+23 -> 2.7620e+23 cm^-3**
- raw vs effective Zbar: **3 -> 3**
...
| target_article_state | article_density_average_fixed_temperature | -1 | 6.3000 | 4.125 | 0.600 | 0.600 | 9.2068e+22 | 2.7620e+23 | 3.000 | 30.00 |
...
| Article Al + driven increment | credible | headline_credible | 3.000 | 0.000 | 3.000 | 2.7620e+23 | none | uniform | cold_baseline_only | benchmark_driven_increment | Al@elements.Al: cold_Zeff=3.000, driven_default=cold_plus_increment, class=simple_metal |
...
|---|---:|---:|---:|---:|---:|
| Auto best per state | 2.824 | 2.824 | 2.824 | 2.824 | 0.000 |
| Finite-T Lindhard | 5.776 | 5.776 | 5.776 | 5.776 | 0.000 |
| Finite-T Lindhard + Mermin | 6.548 | 6.548 | 6.548 | 6.548 | 0.000 |
| Finite-T Lindhard + Mermin + static LFC | 7.294 | 7.294 | 7.294 | 7.294 | 0.000 |
| Finite-T Lindhard + static LFC | 6.591 | 6.591 | 6.591 | 6.591 | 0.000 |
| Mermin | 4.445 | 4.445 | 4.445 | 4.445 | 0.000 |
| Mermin + static LFC | 2.824 | 2.824 | 2.824 | 2.824 | 0.000 |
| Quantum hydrodynamic (experimental) | 5.800 | 5.800 | 5.800 | 5.800 | 0.000 |
| RPA | 4.431 | 4.431 | 4.431 | 4.431 | 0.000 |
| RPA + static LFC | 2.819 | 2.819 | 2.819 | 2.819 | 0.000 |
...
|---|---|---|---|---:|---:|---|
| Finite-T Lindhard | tddft | Article Al + driven increment | legacy_dense_slab -> article_density_average_fixed_temperature | 6.817 | 5.638 | materially improved |
| Finite-T Lindhard + Mermin | tddft | Article Al + driven increment | legacy_dense_slab -> article_density_average_fixed_temperature | 5.685 | 6.411 | worse |
| Finite-T Lindhard + Mermin + static LFC | tddft | Article Al + driven increment | legacy_dense_slab -> article_density_average_fixed_temperature | 7.714 | 7.156 | improved |
| Finite-T Lindhard + static LFC | tddft | Article Al + driven increment | legacy_dense_slab -> article_density_average_fixed_temperature | 7.387 | 6.454 | improved |
| Mermin | rpa | Article Al + driven increment | legacy_dense_slab -> article_density_average_fixed_temperature | 9.089 | 9.382 | worse |
| Mermin + static LFC | lfc | Article Al + driven increment | legacy_dense_slab -> article_density_average_fixed_temperature | 5.278 | 5.609 | worse |
| Quantum hydrodynamic (experimental) | rpa | Article Al + driven increment | legacy_dense_slab -> article_density_average_fixed_temperature | - | 2.462 | not_comparable |
| RPA | rpa | Article Al + driven increment | legacy_dense_slab -> article_density_average_fixed_temperature | 8.977 | 9.369 | worse |
| RPA + static LFC | lfc | Article Al + driven increment | legacy_dense_slab -> article_density_average_fixed_temperature | 5.155 | 5.599 | worse |
...
|---|---:|---:|---:|---:|
| Finite-T Lindhard -> tddft | 5.862 | 5.761 | 5.638 | 5.638 |
| Finite-T Lindhard + Mermin -> tddft | 6.620 | 6.523 | 6.411 | 6.411 |
| Finite-T Lindhard + Mermin + static LFC -> tddft | 7.365 | 7.269 | 7.156 | 7.156 |
| Finite-T Lindhard + static LFC -> tddft | 6.664 | 6.575 | 6.454 | 6.454 |
| Mermin -> rpa | 9.374 | 9.481 | 9.382 | 9.382 |
| Mermin + static LFC -> lfc | 5.567 | 5.677 | 5.609 | 5.609 |
| Quantum hydrodynamic (experimental) -> rpa | 2.400 | 2.433 | 2.462 | 2.462 |
| RPA -> rpa | 9.351 | 9.460 | 9.369 | 9.369 |
| RPA + static LFC -> lfc | 5.547 | 5.667 | 5.599 | 5.599 |
...
|---|---|---|---|---:|---:|---:|---:|
| Finite-T Lindhard | valid | finite_t_lindhard | benchmark_dense | 0.157 | 7 | 3.485 | 3.765 |
| Quantum hydrodynamic (experimental) | valid | quantum_hydrodynamic | benchmark_dense | 0.061 | 7 | 3.950 | 5.865 |
| RPA + static LFC | valid | classical_maxwellian | benchmark_dense | 0.064 | 7 | 4.502 | 5.365 |
| Auto best per state | valid | classical_maxwellian | benchmark_dense | 0.064 | 7 | 4.503 | 5.366 |
| Mermin + static LFC | valid | classical_maxwellian | benchmark_dense | 0.067 | 7 | 4.503 | 5.366 |
| Finite-T Lindhard + Mermin | valid | finite_t_lindhard | benchmark_dense | 0.151 | 7 | 4.647 | 5.348 |
| Finite-T Lindhard + static LFC | valid | finite_t_lindhard | benchmark_dense | 0.066 | 7 | 5.482 | 6.023 |
| RPA | valid | classical_maxwellian | benchmark_dense | 0.135 | 7 | 6.480 | 7.505 |
...
| model | status | backend | collision | runtime mean [s] | valid points | MAE [eV] | RMSE [eV] |
|---|---|---|---|---:|---:|---:|---:|
| RPA + static LFC | valid | classical_maxwellian | benchmark_dense | 0.006 | 5 | 2.819 | 3.536 |
| Mermin + static LFC | valid | classical_maxwellian | benchmark_dense | 0.006 | 5 | 2.824 | 3.547 |
| Auto best per state | valid | classical_maxwellian | benchmark_dense | 0.006 | 5 | 2.824 | 3.547 |
| RPA | valid | classical_maxwellian | benchmark_dense | 0.008 | 5 | 4.431 | 5.480 |
| Mermin | valid | classical_maxwellian | benchmark_dense | 0.005 | 5 | 4.445 | 5.500 |
| Finite-T Lindhard | valid | finite_t_lindhard | benchmark_dense | 0.004 | 5 | 5.776 | 6.394 |
| Quantum hydrodynamic (experimental) | valid | quantum_hydrodynamic | benchmark_dense | 0.006 | 5 | 5.800 | 7.333 |
| Finite-T Lindhard + Mermin | valid | finite_t_lindhard | benchmark_dense | 0.005 | 5 | 6.548 | 7.755 |
| Finite-T Lindhard + static LFC | valid | finite_t_lindhard | benchmark_dense | 0.006 | 5 | 6.591 | 7.060 |
| Finite-T Lindhard + Mermin + static LFC | valid | finite_t_lindhard | benchmark_dense | 0.005 | 5 | 7.294 | 8.213 |
...
- Best practical driven branch on the article-reconciled state is **RPA + static LFC** with MAE **2.819 eV**.
...
- `C:\Users\dimab\Documents\Helios_parser\outputs\validation_outputs\plasmon_new_backend_experiment\noop\all_model_results.json`
- `C:\Users\dimab\Documents\Helios_parser\outputs\validation_outputs\plasmon_new_backend_experiment\noop\benchmark_points.csv`
- `C:\Users\dimab\Documents\Helios_parser\outputs\validation_outputs\plasmon_new_backend_experiment\noop\benchmark_summary.csv`
- `C:\Users\dimab\Documents\Helios_parser\outputs\validation_outputs\plasmon_new_backend_experiment\noop\policy_state_summary.csv`
- `C:\Users\dimab\Documents\Helios_parser\outputs\validation_outputs\plasmon_new_backend_experiment\noop\policy_sensitivity_summary.csv`
- `C:\Users\dimab\Documents\Helios_parser\outputs\validation_outputs\plasmon_new_backend_experiment\noop\reconciliation_summary.csv`
- `C:\Users\dimab\Documents\Helios_parser\outputs\validation_outputs\plasmon_new_backend_experiment\noop\driven_policy_table.csv`
- `C:\Users\dimab\Documents\Helios_parser\outputs\validation_outputs\plasmon_new_backend_experiment\noop\driven_state_comparison.csv`
- `C:\Users\dimab\Documents\Helios_parser\outputs\validation_outputs\plasmon_new_backend_experiment\noop\driven_branch_reconciliation_delta.csv`
- `C:\Users\dimab\Documents\Helios_parser\outputs\validation_outputs\plasmon_new_backend_experiment\noop\ambient_dataset_overlay.png`
- `C:\Users\dimab\Documents\Helios_parser\outputs\validation_outputs\plasmon_new_backend_experiment\noop\driven_legacy_hydro_overlay.png`
- `C:\Users\dimab\Documents\Helios_parser\outputs\validation_outputs\plasmon_new_backend_experiment\noop\driven_best_hydro_overlay.png`
- `C:\Users\dimab\Documents\Helios_parser\outputs\validation_outputs\plasmon_new_backend_experiment\noop\driven_dataset_overlay.png`
- `C:\Users\dimab\Documents\Helios_parser\outputs\validation_outputs\plasmon_new_backend_experiment\noop\ambient_representative_spectra.png`
- `C:\Users\dimab\Documents\Helios_parser\outputs\validation_outputs\plasmon_new_backend_experiment\noop\driven_representative_spectra.png`