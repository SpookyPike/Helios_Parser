...
- driven response model: **Scalar driven increment control (scalar_increment_control)**
- driven ensemble response mode: **spectrum_average**
...
- classical response cache stats: **{'finite_t_susceptibility_hits': 2298, 'finite_t_susceptibility_misses': 3282, 'finite_t_susceptibility_currsize': 512, 'finite_t_susceptibility_maxsize': 512}**
...
| Article Al + driven increment | credible | headline_credible | 3.000 | 0.345 | 3.345 | 3.0833e+23 | scalar_increment_control | uniform | cold_baseline_only | benchmark_driven_increment | Al@elements.Al: cold_Zeff=3.000, driven_default=cold_plus_increment, class=simple_metal |
...
|---|---:|---:|---:|---:|---:|
| Auto best per state | 2.824 | 2.293 | 2.824 | 2.824 | 0.530 |
| Mermin + static LFC | 2.824 | 2.293 | 2.824 | 2.824 | 0.530 |
| RPA + static LFC | 2.819 | 2.288 | 2.819 | 2.819 | 0.531 |
| RPA | 4.431 | 3.692 | 4.431 | 4.431 | 0.740 |
| Mermin | 4.445 | 3.702 | 4.445 | 4.445 | 0.743 |
| Quantum hydrodynamic (experimental) | 5.800 | 6.691 | 5.800 | 5.800 | 0.891 |
| Finite-T Lindhard + Mermin | 6.548 | 7.443 | 6.548 | 6.548 | 0.894 |
| Finite-T Lindhard + Mermin + static LFC | 7.294 | 8.189 | 7.294 | 7.294 | 0.896 |
| Finite-T Lindhard | 5.776 | 6.804 | 5.776 | 5.776 | 1.028 |
| Finite-T Lindhard + static LFC | 6.591 | 7.707 | 6.591 | 6.591 | 1.116 |
...
|---|---|---|---|---:|---:|---|
| Finite-T Lindhard | tddft | Article Al + driven increment | legacy_dense_slab -> article_density_average_fixed_temperature | 6.817 | 6.666 | no material change |
| Finite-T Lindhard + Mermin | tddft | Article Al + driven increment | legacy_dense_slab -> article_density_average_fixed_temperature | 5.685 | 7.305 | worse |
| Finite-T Lindhard + Mermin + static LFC | tddft | Article Al + driven increment | legacy_dense_slab -> article_density_average_fixed_temperature | 7.714 | 8.052 | worse |
| Finite-T Lindhard + static LFC | tddft | Article Al + driven increment | legacy_dense_slab -> article_density_average_fixed_temperature | 7.387 | 7.569 | no material change |
| Mermin | rpa | Article Al + driven increment | legacy_dense_slab -> article_density_average_fixed_temperature | 9.089 | 8.325 | improved |
| Mermin + static LFC | lfc | Article Al + driven increment | legacy_dense_slab -> article_density_average_fixed_temperature | 5.278 | 4.532 | improved |
| Quantum hydrodynamic (experimental) | rpa | Article Al + driven increment | legacy_dense_slab -> article_density_average_fixed_temperature | - | 2.276 | not_comparable |
| RPA | rpa | Article Al + driven increment | legacy_dense_slab -> article_density_average_fixed_temperature | 8.977 | 8.283 | improved |
| RPA + static LFC | lfc | Article Al + driven increment | legacy_dense_slab -> article_density_average_fixed_temperature | 5.155 | 4.523 | improved |
...
|---|---:|---:|---:|---:|
| Finite-T Lindhard -> tddft | 5.862 | 5.761 | 5.638 | 6.666 |
| Finite-T Lindhard + Mermin -> tddft | 6.620 | 6.523 | 6.411 | 7.305 |
| Finite-T Lindhard + Mermin + static LFC -> tddft | 7.365 | 7.269 | 7.156 | 8.052 |
| Finite-T Lindhard + static LFC -> tddft | 6.664 | 6.575 | 6.454 | 7.569 |
| Mermin -> rpa | 9.374 | 9.481 | 9.382 | 8.325 |
| Mermin + static LFC -> lfc | 5.567 | 5.677 | 5.609 | 4.532 |
| Quantum hydrodynamic (experimental) -> rpa | 2.400 | 2.433 | 2.462 | 2.276 |
| RPA -> rpa | 9.351 | 9.460 | 9.369 | 8.283 |
| RPA + static LFC -> lfc | 5.547 | 5.667 | 5.599 | 4.523 |
...
|---|---|---|---|---:|---:|---:|---:|
| Finite-T Lindhard | valid | finite_t_lindhard | benchmark_dense | 0.178 | 7 | 3.485 | 3.765 |
| Quantum hydrodynamic (experimental) | valid | quantum_hydrodynamic | benchmark_dense | 0.068 | 7 | 3.950 | 5.865 |
| RPA + static LFC | valid | classical_maxwellian | benchmark_dense | 0.063 | 7 | 4.502 | 5.365 |
| Mermin + static LFC | valid | classical_maxwellian | benchmark_dense | 0.058 | 7 | 4.503 | 5.366 |
| Auto best per state | valid | classical_maxwellian | benchmark_dense | 0.070 | 7 | 4.503 | 5.366 |
| Finite-T Lindhard + Mermin | valid | finite_t_lindhard | benchmark_dense | 0.159 | 7 | 4.647 | 5.348 |
| Finite-T Lindhard + static LFC | valid | finite_t_lindhard | benchmark_dense | 0.063 | 7 | 5.482 | 6.023 |
| RPA | valid | classical_maxwellian | benchmark_dense | 0.131 | 7 | 6.480 | 7.505 |
| Mermin | valid | classical_maxwellian | benchmark_dense | 0.135 | 7 | 6.482 | 7.506 |
| Quick look | not_applicable | classical_maxwellian | benchmark_dense | 0.049 | 7 | 6.528 | 7.560 |
| Finite-T Lindhard + Mermin + static LFC | valid | finite_t_lindhard | benchmark_dense | 0.060 | 7 | 7.215 | 8.866 |

### Driven article-reconciled state vs experiment

| model | status | backend | collision | runtime mean [s] | valid points | MAE [eV] | RMSE [eV] |
|---|---|---|---|---:|---:|---:|---:|
| RPA + static LFC | valid | classical_maxwellian | benchmark_dense | 0.006 | 5 | 2.288 | 2.868 |
| Auto best per state | valid | classical_maxwellian | benchmark_dense | 0.007 | 5 | 2.293 | 2.877 |
| Mermin + static LFC | valid | classical_maxwellian | benchmark_dense | 0.010 | 5 | 2.293 | 2.877 |
| RPA | valid | classical_maxwellian | benchmark_dense | 0.269 | 5 | 3.692 | 4.695 |
| Mermin | valid | classical_maxwellian | benchmark_dense | 0.277 | 5 | 3.702 | 4.719 |
| Quantum hydrodynamic (experimental) | valid | quantum_hydrodynamic | benchmark_dense | 0.005 | 5 | 6.691 | 7.783 |
| Finite-T Lindhard | valid | finite_t_lindhard | benchmark_dense | 0.397 | 5 | 6.804 | 7.228 |
| Finite-T Lindhard + Mermin | valid | finite_t_lindhard | benchmark_dense | 0.381 | 5 | 7.443 | 8.294 |
| Finite-T Lindhard + static LFC | valid | finite_t_lindhard | benchmark_dense | 0.004 | 5 | 7.707 | 8.067 |
| Finite-T Lindhard + Mermin + static LFC | valid | finite_t_lindhard | benchmark_dense | 0.005 | 5 | 8.189 | 8.826 |
...
- Best practical driven branch on the article-reconciled state is **RPA + static LFC** with MAE **2.288 eV**.
...
- `C:\Users\dimab\Documents\Helios_parser\outputs\validation_outputs\plasmon_new_backend_experiment\scalar_control\all_model_results.json`
- `C:\Users\dimab\Documents\Helios_parser\outputs\validation_outputs\plasmon_new_backend_experiment\scalar_control\benchmark_points.csv`
- `C:\Users\dimab\Documents\Helios_parser\outputs\validation_outputs\plasmon_new_backend_experiment\scalar_control\benchmark_summary.csv`
- `C:\Users\dimab\Documents\Helios_parser\outputs\validation_outputs\plasmon_new_backend_experiment\scalar_control\policy_state_summary.csv`
- `C:\Users\dimab\Documents\Helios_parser\outputs\validation_outputs\plasmon_new_backend_experiment\scalar_control\policy_sensitivity_summary.csv`
- `C:\Users\dimab\Documents\Helios_parser\outputs\validation_outputs\plasmon_new_backend_experiment\scalar_control\reconciliation_summary.csv`
- `C:\Users\dimab\Documents\Helios_parser\outputs\validation_outputs\plasmon_new_backend_experiment\scalar_control\driven_policy_table.csv`
- `C:\Users\dimab\Documents\Helios_parser\outputs\validation_outputs\plasmon_new_backend_experiment\scalar_control\driven_state_comparison.csv`
- `C:\Users\dimab\Documents\Helios_parser\outputs\validation_outputs\plasmon_new_backend_experiment\scalar_control\driven_branch_reconciliation_delta.csv`
- `C:\Users\dimab\Documents\Helios_parser\outputs\validation_outputs\plasmon_new_backend_experiment\scalar_control\ambient_dataset_overlay.png`
- `C:\Users\dimab\Documents\Helios_parser\outputs\validation_outputs\plasmon_new_backend_experiment\scalar_control\driven_legacy_hydro_overlay.png`
- `C:\Users\dimab\Documents\Helios_parser\outputs\validation_outputs\plasmon_new_backend_experiment\scalar_control\driven_best_hydro_overlay.png`
- `C:\Users\dimab\Documents\Helios_parser\outputs\validation_outputs\plasmon_new_backend_experiment\scalar_control\driven_dataset_overlay.png`
- `C:\Users\dimab\Documents\Helios_parser\outputs\validation_outputs\plasmon_new_backend_experiment\scalar_control\ambient_representative_spectra.png`
- `C:\Users\dimab\Documents\Helios_parser\outputs\validation_outputs\plasmon_new_backend_experiment\scalar_control\driven_representative_spectra.png`