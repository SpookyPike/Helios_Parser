...
| Quantum hydrodynamic (experimental) | 5.800 | 6.770 | 5.800 | 5.800 | 0.970 |
...
| Quantum hydrodynamic (experimental) | rpa | Article Al + driven increment | legacy_dense_slab -> article_density_average_fixed_temperature | - | 2.301 | not_comparable |
...
| Quantum hydrodynamic (experimental) -> rpa | 2.400 | 2.433 | 2.462 | 2.301 |
...
| Auto best per state | valid | classical_maxwellian | benchmark_dense | 0.067 | 7 | 4.503 | 5.366 |
...
| Finite-T Lindhard + static LFC | valid | finite_t_lindhard | benchmark_dense | 0.062 | 7 | 5.482 | 6.023 |
| RPA | valid | classical_maxwellian | benchmark_dense | 0.127 | 7 | 6.480 | 7.505 |
| Mermin | valid | classical_maxwellian | benchmark_dense | 0.132 | 7 | 6.482 | 7.506 |
| Quick look | not_applicable | classical_maxwellian | benchmark_dense | 0.050 | 7 | 6.528 | 7.560 |
| Finite-T Lindhard + Mermin + static LFC | valid | finite_t_lindhard | benchmark_dense | 0.064 | 7 | 7.215 | 8.866 |

### Driven article-reconciled state vs experiment

| model | status | backend | collision | runtime mean [s] | valid points | MAE [eV] | RMSE [eV] |
|---|---|---|---|---:|---:|---:|---:|
| RPA + static LFC | valid | classical_maxwellian | benchmark_dense | 0.007 | 5 | 2.241 | 2.822 |
| Auto best per state | valid | classical_maxwellian | benchmark_dense | 0.007 | 5 | 2.249 | 2.833 |
| Mermin + static LFC | valid | classical_maxwellian | benchmark_dense | 0.009 | 5 | 2.249 | 2.833 |
| RPA | valid | classical_maxwellian | benchmark_dense | 0.257 | 5 | 3.652 | 4.637 |
| Mermin | valid | classical_maxwellian | benchmark_dense | 0.308 | 5 | 3.660 | 4.660 |
| Quantum hydrodynamic (experimental) | valid | quantum_hydrodynamic | benchmark_dense | 0.006 | 5 | 6.770 | 7.828 |
| Finite-T Lindhard | valid | finite_t_lindhard | benchmark_dense | 0.385 | 5 | 6.892 | 7.301 |
| Finite-T Lindhard + Mermin | valid | finite_t_lindhard | benchmark_dense | 0.386 | 5 | 7.519 | 8.345 |
| Finite-T Lindhard + static LFC | valid | finite_t_lindhard | benchmark_dense | 0.006 | 5 | 7.819 | 8.179 |
...
- `C:\Users\dimab\Documents\Helios_parser\outputs\validation_outputs\plasmon_new_backend_experiment\electron_column_weighted_control\all_model_results.json`
- `C:\Users\dimab\Documents\Helios_parser\outputs\validation_outputs\plasmon_new_backend_experiment\electron_column_weighted_control\benchmark_points.csv`
- `C:\Users\dimab\Documents\Helios_parser\outputs\validation_outputs\plasmon_new_backend_experiment\electron_column_weighted_control\benchmark_summary.csv`
- `C:\Users\dimab\Documents\Helios_parser\outputs\validation_outputs\plasmon_new_backend_experiment\electron_column_weighted_control\policy_state_summary.csv`
- `C:\Users\dimab\Documents\Helios_parser\outputs\validation_outputs\plasmon_new_backend_experiment\electron_column_weighted_control\policy_sensitivity_summary.csv`
- `C:\Users\dimab\Documents\Helios_parser\outputs\validation_outputs\plasmon_new_backend_experiment\electron_column_weighted_control\reconciliation_summary.csv`
- `C:\Users\dimab\Documents\Helios_parser\outputs\validation_outputs\plasmon_new_backend_experiment\electron_column_weighted_control\driven_policy_table.csv`
- `C:\Users\dimab\Documents\Helios_parser\outputs\validation_outputs\plasmon_new_backend_experiment\electron_column_weighted_control\driven_state_comparison.csv`
- `C:\Users\dimab\Documents\Helios_parser\outputs\validation_outputs\plasmon_new_backend_experiment\electron_column_weighted_control\driven_branch_reconciliation_delta.csv`
- `C:\Users\dimab\Documents\Helios_parser\outputs\validation_outputs\plasmon_new_backend_experiment\electron_column_weighted_control\ambient_dataset_overlay.png`
- `C:\Users\dimab\Documents\Helios_parser\outputs\validation_outputs\plasmon_new_backend_experiment\electron_column_weighted_control\driven_legacy_hydro_overlay.png`
- `C:\Users\dimab\Documents\Helios_parser\outputs\validation_outputs\plasmon_new_backend_experiment\electron_column_weighted_control\driven_best_hydro_overlay.png`
- `C:\Users\dimab\Documents\Helios_parser\outputs\validation_outputs\plasmon_new_backend_experiment\electron_column_weighted_control\driven_dataset_overlay.png`
- `C:\Users\dimab\Documents\Helios_parser\outputs\validation_outputs\plasmon_new_backend_experiment\electron_column_weighted_control\ambient_representative_spectra.png`
- `C:\Users\dimab\Documents\Helios_parser\outputs\validation_outputs\plasmon_new_backend_experiment\electron_column_weighted_control\driven_representative_spectra.png`