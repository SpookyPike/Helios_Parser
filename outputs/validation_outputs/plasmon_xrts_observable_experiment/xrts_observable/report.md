...
| Finite-T STLS (experimental) | 20.537 | 8.776 | 20.537 | 20.537 | 11.761 |
...
|---|---|---|---|---:|---:|---|
| Finite-T STLS (experimental) | lfc | Article Al + driven increment | legacy_dense_slab -> article_density_average_fixed_temperature | - | 7.760 | not_comparable |
...
|---|---:|---:|---:|---:|
| Finite-T STLS (experimental) -> lfc | 0.218 | 0.241 | 22.467 | 7.760 |
...
|---|---|---|---|---:|---:|---:|---:|
| Finite-T STLS (experimental) | valid | finite_t_stls | benchmark_dense | 0.150 | 7 | 2.307 | 2.526 |
| Quantum hydrodynamic (experimental) | valid | quantum_hydrodynamic | benchmark_dense | 0.068 | 7 | 3.950 | 5.865 |
| RPA + static LFC | valid | classical_maxwellian | benchmark_dense | 0.071 | 7 | 4.502 | 5.365 |
| RPA | valid | classical_maxwellian | benchmark_dense | 0.066 | 7 | 6.480 | 7.505 |

### Driven article-reconciled state vs experiment

| model | status | backend | collision | runtime mean [s] | valid points | MAE [eV] | RMSE [eV] |
|---|---|---|---|---:|---:|---:|---:|
| RPA + static LFC | valid | classical_maxwellian | benchmark_dense | 0.010 | 5 | 2.277 | 2.857 |
| RPA | valid | classical_maxwellian | benchmark_dense | 0.010 | 5 | 3.683 | 4.682 |
| Quantum hydrodynamic (experimental) | valid | quantum_hydrodynamic | benchmark_dense | 0.010 | 5 | 6.709 | 7.793 |
| Finite-T STLS (experimental) | valid | finite_t_stls | collisionless_stls | 0.405 | 5 | 8.776 | 13.031 |
...
- `outputs\validation_outputs\plasmon_xrts_observable_experiment\xrts_observable\all_model_results.json`
- `outputs\validation_outputs\plasmon_xrts_observable_experiment\xrts_observable\benchmark_points.csv`
- `outputs\validation_outputs\plasmon_xrts_observable_experiment\xrts_observable\benchmark_summary.csv`
- `outputs\validation_outputs\plasmon_xrts_observable_experiment\xrts_observable\policy_state_summary.csv`
- `outputs\validation_outputs\plasmon_xrts_observable_experiment\xrts_observable\policy_sensitivity_summary.csv`
- `outputs\validation_outputs\plasmon_xrts_observable_experiment\xrts_observable\reconciliation_summary.csv`
- `outputs\validation_outputs\plasmon_xrts_observable_experiment\xrts_observable\driven_policy_table.csv`
- `outputs\validation_outputs\plasmon_xrts_observable_experiment\xrts_observable\driven_state_comparison.csv`
- `outputs\validation_outputs\plasmon_xrts_observable_experiment\xrts_observable\driven_branch_reconciliation_delta.csv`
- `outputs\validation_outputs\plasmon_xrts_observable_experiment\xrts_observable\ambient_dataset_overlay.png`
- `outputs\validation_outputs\plasmon_xrts_observable_experiment\xrts_observable\driven_legacy_hydro_overlay.png`
- `outputs\validation_outputs\plasmon_xrts_observable_experiment\xrts_observable\driven_best_hydro_overlay.png`
- `outputs\validation_outputs\plasmon_xrts_observable_experiment\xrts_observable\driven_dataset_overlay.png`
- `outputs\validation_outputs\plasmon_xrts_observable_experiment\xrts_observable\ambient_representative_spectra.png`
- `outputs\validation_outputs\plasmon_xrts_observable_experiment\xrts_observable\driven_representative_spectra.png`