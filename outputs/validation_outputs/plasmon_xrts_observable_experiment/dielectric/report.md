...
- observable mode: **Dielectric-only (dielectric)**
...
| Finite-T STLS (experimental) | 2.643 | 3.618 | 2.643 | 2.643 | 0.974 |
...
|---|---|---|---|---:|---:|---|
| Finite-T STLS (experimental) | lfc | Article Al + driven increment | legacy_dense_slab -> article_density_average_fixed_temperature | - | 0.730 | not_comparable |
...
|---|---:|---:|---:|---:|
| Finite-T STLS (experimental) -> lfc | 0.218 | 0.241 | 0.394 | 0.730 |
...
|---|---|---|---|---:|---:|---:|---:|
| Finite-T STLS (experimental) | valid | finite_t_stls | benchmark_dense | 0.210 | 7 | 2.307 | 2.526 |
| Quantum hydrodynamic (experimental) | valid | quantum_hydrodynamic | benchmark_dense | 0.062 | 7 | 3.950 | 5.865 |
| RPA + static LFC | valid | classical_maxwellian | benchmark_dense | 0.056 | 7 | 4.502 | 5.365 |
| RPA | valid | classical_maxwellian | benchmark_dense | 0.106 | 7 | 6.480 | 7.505 |

### Driven article-reconciled state vs experiment

| model | status | backend | collision | runtime mean [s] | valid points | MAE [eV] | RMSE [eV] |
|---|---|---|---|---:|---:|---:|---:|
| RPA + static LFC | valid | classical_maxwellian | benchmark_dense | 0.009 | 5 | 2.288 | 2.868 |
| Finite-T STLS (experimental) | valid | finite_t_stls | collisionless_stls | 0.636 | 5 | 3.618 | 3.721 |
| RPA | valid | classical_maxwellian | benchmark_dense | 0.290 | 5 | 3.692 | 4.695 |
| Quantum hydrodynamic (experimental) | valid | quantum_hydrodynamic | benchmark_dense | 0.006 | 5 | 6.691 | 7.783 |
...
- `outputs\validation_outputs\plasmon_xrts_observable_experiment\dielectric\all_model_results.json`
- `outputs\validation_outputs\plasmon_xrts_observable_experiment\dielectric\benchmark_points.csv`
- `outputs\validation_outputs\plasmon_xrts_observable_experiment\dielectric\benchmark_summary.csv`
- `outputs\validation_outputs\plasmon_xrts_observable_experiment\dielectric\policy_state_summary.csv`
- `outputs\validation_outputs\plasmon_xrts_observable_experiment\dielectric\policy_sensitivity_summary.csv`
- `outputs\validation_outputs\plasmon_xrts_observable_experiment\dielectric\reconciliation_summary.csv`
- `outputs\validation_outputs\plasmon_xrts_observable_experiment\dielectric\driven_policy_table.csv`
- `outputs\validation_outputs\plasmon_xrts_observable_experiment\dielectric\driven_state_comparison.csv`
- `outputs\validation_outputs\plasmon_xrts_observable_experiment\dielectric\driven_branch_reconciliation_delta.csv`
- `outputs\validation_outputs\plasmon_xrts_observable_experiment\dielectric\ambient_dataset_overlay.png`
- `outputs\validation_outputs\plasmon_xrts_observable_experiment\dielectric\driven_legacy_hydro_overlay.png`
- `outputs\validation_outputs\plasmon_xrts_observable_experiment\dielectric\driven_best_hydro_overlay.png`
- `outputs\validation_outputs\plasmon_xrts_observable_experiment\dielectric\driven_dataset_overlay.png`
- `outputs\validation_outputs\plasmon_xrts_observable_experiment\dielectric\ambient_representative_spectra.png`
- `outputs\validation_outputs\plasmon_xrts_observable_experiment\dielectric\driven_representative_spectra.png`