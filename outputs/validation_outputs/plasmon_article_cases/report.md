...
|---|---|---|---:|---:|---:|---:|
| Finite-T Lindhard | valid | finite_t_lindhard | 0.148 | 7 | 3.485 | 3.765 |
| Auto best per state | valid | classical_maxwellian | 0.048 | 7 | 4.502 | 5.365 |
| RPA + static LFC | valid | classical_maxwellian | 0.272 | 7 | 4.502 | 5.365 |
| Finite-T Lindhard + static LFC | valid | finite_t_lindhard | 0.040 | 7 | 5.482 | 6.023 |
| RPA | valid | classical_maxwellian | 0.210 | 7 | 6.480 | 7.505 |
| Quick look | not_applicable | classical_maxwellian | 0.031 | 7 | 6.528 | 7.560 |
| Mermin | invalid_for_benchmark | classical_maxwellian | 0.036 | 0 | nan | nan |
| Finite-T Lindhard + Mermin | invalid_for_benchmark | finite_t_lindhard | 0.042 | 0 | nan | nan |
| Mermin + static LFC | invalid_for_benchmark | classical_maxwellian | 0.046 | 0 | nan | nan |
| Finite-T Lindhard + Mermin + static LFC | invalid_for_benchmark | finite_t_lindhard | 0.049 | 0 | nan | nan |

## 3. Driven ranking vs experiment

| model | status | backend | runtime mean [s] | valid points | MAE [eV] | RMSE [eV] |
|---|---|---|---:|---:|---:|---:|
| Auto best per state | valid | classical_maxwellian | 0.052 | 5 | 2.679 | 3.364 |
| RPA + static LFC | valid | classical_maxwellian | 6.352 | 5 | 2.679 | 3.364 |
| RPA | valid | classical_maxwellian | 6.315 | 5 | 4.111 | 5.322 |
| Quick look | not_applicable | classical_maxwellian | 0.034 | 5 | 5.085 | 6.405 |
| Finite-T Lindhard | valid | finite_t_lindhard | 3.074 | 5 | 6.955 | 7.610 |
| Finite-T Lindhard + static LFC | valid | finite_t_lindhard | 0.051 | 5 | 7.525 | 8.012 |
| Finite-T Lindhard + Mermin | invalid_for_benchmark | finite_t_lindhard | 0.035 | 0 | nan | nan |
| Finite-T Lindhard + Mermin + static LFC | invalid_for_benchmark | finite_t_lindhard | 0.038 | 0 | nan | nan |
| Mermin + static LFC | invalid_for_benchmark | classical_maxwellian | 0.040 | 0 | nan | nan |
| Mermin | invalid_for_benchmark | classical_maxwellian | 0.041 | 0 | nan | nan |
