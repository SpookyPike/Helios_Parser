...
| Mermin + static LFC | valid | classical_maxwellian | benchmark_dense | 0.065 | 7 | 4.503 | 5.366 |
| Auto best per state | valid | classical_maxwellian | benchmark_dense | 0.073 | 7 | 4.503 | 5.366 |
| Finite-T Lindhard + Mermin | valid | finite_t_lindhard | benchmark_dense | 0.186 | 7 | 4.647 | 5.348 |
| Finite-T Lindhard + static LFC | valid | finite_t_lindhard | benchmark_dense | 0.071 | 7 | 5.482 | 6.023 |
| RPA | valid | classical_maxwellian | benchmark_dense | 0.160 | 7 | 6.480 | 7.505 |
| Mermin | valid | classical_maxwellian | benchmark_dense | 0.135 | 7 | 6.482 | 7.506 |
| Quick look | not_applicable | classical_maxwellian | benchmark_dense | 0.051 | 7 | 6.528 | 7.560 |
| Finite-T Lindhard + Mermin + static LFC | valid | finite_t_lindhard | benchmark_dense | 0.071 | 7 | 7.215 | 8.866 |
...
| Mermin + static LFC | valid | classical_maxwellian | benchmark_dense | 0.007 | 5 | 2.293 | 2.877 |
| Auto best per state | valid | classical_maxwellian | benchmark_dense | 0.010 | 5 | 2.293 | 2.877 |
| RPA | valid | classical_maxwellian | benchmark_dense | 0.283 | 5 | 3.692 | 4.695 |
| Mermin | valid | classical_maxwellian | benchmark_dense | 0.272 | 5 | 3.702 | 4.719 |
| Finite-T Lindhard | valid | finite_t_lindhard | benchmark_dense | 0.434 | 5 | 6.804 | 7.228 |
| Finite-T Lindhard + Mermin | valid | finite_t_lindhard | benchmark_dense | 0.426 | 5 | 7.443 | 8.294 |
| Finite-T Lindhard + static LFC | valid | finite_t_lindhard | benchmark_dense | 0.010 | 5 | 7.707 | 8.067 |
| Finite-T Lindhard + Mermin + static LFC | valid | finite_t_lindhard | benchmark_dense | 0.010 | 5 | 8.189 | 8.826 |
| Quick look | invalid_for_benchmark | classical_maxwellian | benchmark_dense | 0.003 | 0 | nan | nan |
...
- `outputs\validation_outputs\plasmon_article_cases_experimental_response_model\scalar_control\all_model_results.json`
- `outputs\validation_outputs\plasmon_article_cases_experimental_response_model\scalar_control\benchmark_points.csv`
- `outputs\validation_outputs\plasmon_article_cases_experimental_response_model\scalar_control\benchmark_summary.csv`
- `outputs\validation_outputs\plasmon_article_cases_experimental_response_model\scalar_control\policy_state_summary.csv`
- `outputs\validation_outputs\plasmon_article_cases_experimental_response_model\scalar_control\policy_sensitivity_summary.csv`
- `outputs\validation_outputs\plasmon_article_cases_experimental_response_model\scalar_control\reconciliation_summary.csv`
- `outputs\validation_outputs\plasmon_article_cases_experimental_response_model\scalar_control\driven_policy_table.csv`
- `outputs\validation_outputs\plasmon_article_cases_experimental_response_model\scalar_control\driven_state_comparison.csv`
- `outputs\validation_outputs\plasmon_article_cases_experimental_response_model\scalar_control\driven_branch_reconciliation_delta.csv`
- `outputs\validation_outputs\plasmon_article_cases_experimental_response_model\scalar_control\ambient_dataset_overlay.png`
- `outputs\validation_outputs\plasmon_article_cases_experimental_response_model\scalar_control\driven_legacy_hydro_overlay.png`
- `outputs\validation_outputs\plasmon_article_cases_experimental_response_model\scalar_control\driven_best_hydro_overlay.png`
- `outputs\validation_outputs\plasmon_article_cases_experimental_response_model\scalar_control\driven_dataset_overlay.png`
- `outputs\validation_outputs\plasmon_article_cases_experimental_response_model\scalar_control\ambient_representative_spectra.png`
- `outputs\validation_outputs\plasmon_article_cases_experimental_response_model\scalar_control\driven_representative_spectra.png`