...
|---|---|---|---|---:|---:|---:|---:|
| Finite-T Lindhard | valid | finite_t_lindhard | benchmark_dense | 0.156 | 7 | 3.485 | 3.765 |
| RPA + static LFC | valid | classical_maxwellian | benchmark_dense | 0.062 | 7 | 4.502 | 5.365 |
| Auto best per state | valid | classical_maxwellian | benchmark_dense | 0.069 | 7 | 4.503 | 5.366 |
| Mermin + static LFC | valid | classical_maxwellian | benchmark_dense | 0.069 | 7 | 4.503 | 5.366 |
| Finite-T Lindhard + Mermin | valid | finite_t_lindhard | benchmark_dense | 0.180 | 7 | 4.647 | 5.348 |
| Finite-T Lindhard + static LFC | valid | finite_t_lindhard | benchmark_dense | 0.065 | 7 | 5.482 | 6.023 |
| RPA | valid | classical_maxwellian | benchmark_dense | 0.137 | 7 | 6.480 | 7.505 |
| Mermin | valid | classical_maxwellian | benchmark_dense | 0.134 | 7 | 6.482 | 7.506 |
| Quick look | not_applicable | classical_maxwellian | benchmark_dense | 0.052 | 7 | 6.528 | 7.560 |
| Finite-T Lindhard + Mermin + static LFC | valid | finite_t_lindhard | benchmark_dense | 0.069 | 7 | 7.215 | 8.866 |

### Driven article-reconciled state vs experiment

| model | status | backend | collision | runtime mean [s] | valid points | MAE [eV] | RMSE [eV] |
|---|---|---|---|---:|---:|---:|---:|
| RPA + static LFC | valid | classical_maxwellian | benchmark_dense | 0.007 | 5 | 2.819 | 3.536 |
| Auto best per state | valid | classical_maxwellian | benchmark_dense | 0.007 | 5 | 2.824 | 3.547 |
| Mermin + static LFC | valid | classical_maxwellian | benchmark_dense | 0.009 | 5 | 2.824 | 3.547 |
| RPA | valid | classical_maxwellian | benchmark_dense | 0.007 | 5 | 4.431 | 5.480 |
| Mermin | valid | classical_maxwellian | benchmark_dense | 0.008 | 5 | 4.445 | 5.500 |
| Finite-T Lindhard | valid | finite_t_lindhard | benchmark_dense | 0.005 | 5 | 5.776 | 6.394 |
| Finite-T Lindhard + Mermin | valid | finite_t_lindhard | benchmark_dense | 0.007 | 5 | 6.548 | 7.755 |
| Finite-T Lindhard + static LFC | valid | finite_t_lindhard | benchmark_dense | 0.005 | 5 | 6.591 | 7.060 |
...
- `outputs\validation_outputs\plasmon_article_cases_experimental_response_model\noop\all_model_results.json`
