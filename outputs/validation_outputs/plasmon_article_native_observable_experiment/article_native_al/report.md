...
- driven response model: **Policy default (policy_default)**
- observable mode: **XRTS article-native Al (xrts_article_native_al)**
...
- classical response cache stats: **{'finite_t_susceptibility_hits': 1355, 'finite_t_susceptibility_misses': 377, 'finite_t_susceptibility_currsize': 377, 'finite_t_susceptibility_maxsize': 512}**
...
|---|---:|---:|---:|---:|---:|
| RPA + static LFC | 2.819 | 2.277 | 2.819 | 2.819 | 0.542 |
| RPA | 4.431 | 3.683 | 4.431 | 4.431 | 0.749 |
| Quantum hydrodynamic (experimental) | 5.800 | 6.709 | 5.800 | 5.800 | 0.909 |
| Finite-T STLS (experimental) | 2.643 | 3.640 | 2.643 | 2.643 | 0.997 |
...
|---|---|---|---|---:|---:|---|
| Finite-T STLS (experimental) | lfc | Article Al + driven increment | legacy_dense_slab -> article_density_average_fixed_temperature | - | 0.749 | not_comparable |
| Quantum hydrodynamic (experimental) | rpa | Article Al + driven increment | legacy_dense_slab -> article_density_average_fixed_temperature | - | 2.282 | not_comparable |
| RPA | rpa | Article Al + driven increment | legacy_dense_slab -> article_density_average_fixed_temperature | 8.977 | 8.264 | improved |
| RPA + static LFC | lfc | Article Al + driven increment | legacy_dense_slab -> article_density_average_fixed_temperature | 5.155 | 4.501 | improved |
...
|---|---:|---:|---:|---:|
| Finite-T STLS (experimental) -> lfc | 0.218 | 0.241 | 0.394 | 0.749 |
| Quantum hydrodynamic (experimental) -> rpa | 2.400 | 2.433 | 2.462 | 2.282 |
| RPA -> rpa | 9.351 | 9.460 | 9.369 | 8.264 |
| RPA + static LFC -> lfc | 5.547 | 5.667 | 5.599 | 4.501 |
...
|---|---|---|---|---:|---:|---:|---:|
| Finite-T STLS (experimental) | valid | finite_t_stls | benchmark_dense | 0.158 | 7 | 2.307 | 2.526 |
| Quantum hydrodynamic (experimental) | valid | quantum_hydrodynamic | benchmark_dense | 0.065 | 7 | 3.950 | 5.865 |
| RPA + static LFC | valid | classical_maxwellian | benchmark_dense | 0.067 | 7 | 4.502 | 5.365 |
| RPA | valid | classical_maxwellian | benchmark_dense | 0.067 | 7 | 6.480 | 7.505 |

### Driven article-reconciled state vs experiment

| model | status | backend | collision | runtime mean [s] | valid points | MAE [eV] | RMSE [eV] |
|---|---|---|---|---:|---:|---:|---:|
| RPA + static LFC | valid | classical_maxwellian | benchmark_dense | 0.015 | 5 | 2.277 | 2.857 |
| Finite-T STLS (experimental) | valid | finite_t_stls | collisionless_stls | 0.378 | 5 | 3.640 | 3.745 |
| RPA | valid | classical_maxwellian | benchmark_dense | 0.010 | 5 | 3.683 | 4.682 |
| Quantum hydrodynamic (experimental) | valid | quantum_hydrodynamic | benchmark_dense | 0.011 | 5 | 6.709 | 7.793 |

## F. Judged conclusions

- Best practical ambient benchmark branch remains **Finite-T STLS (experimental)** with MAE **2.307 eV**.
- Best practical driven branch on the article-reconciled state is **RPA + static LFC** with MAE **2.277 eV**.
...
- `outputs\validation_outputs\plasmon_article_native_observable_experiment\article_native_al\all_model_results.json`
- `outputs\validation_outputs\plasmon_article_native_observable_experiment\article_native_al\benchmark_points.csv`
- `outputs\validation_outputs\plasmon_article_native_observable_experiment\article_native_al\benchmark_summary.csv`
- `outputs\validation_outputs\plasmon_article_native_observable_experiment\article_native_al\policy_state_summary.csv`
- `outputs\validation_outputs\plasmon_article_native_observable_experiment\article_native_al\policy_sensitivity_summary.csv`
- `outputs\validation_outputs\plasmon_article_native_observable_experiment\article_native_al\reconciliation_summary.csv`
- `outputs\validation_outputs\plasmon_article_native_observable_experiment\article_native_al\driven_policy_table.csv`
- `outputs\validation_outputs\plasmon_article_native_observable_experiment\article_native_al\driven_state_comparison.csv`
- `outputs\validation_outputs\plasmon_article_native_observable_experiment\article_native_al\driven_branch_reconciliation_delta.csv`
- `outputs\validation_outputs\plasmon_article_native_observable_experiment\article_native_al\ambient_dataset_overlay.png`
- `outputs\validation_outputs\plasmon_article_native_observable_experiment\article_native_al\driven_legacy_hydro_overlay.png`
- `outputs\validation_outputs\plasmon_article_native_observable_experiment\article_native_al\driven_best_hydro_overlay.png`
- `outputs\validation_outputs\plasmon_article_native_observable_experiment\article_native_al\driven_dataset_overlay.png`
- `outputs\validation_outputs\plasmon_article_native_observable_experiment\article_native_al\ambient_representative_spectra.png`
- `outputs\validation_outputs\plasmon_article_native_observable_experiment\article_native_al\driven_representative_spectra.png`