...
- observable mode: **XRTS observable (xrts_observable)**
...
- classical response cache stats: **{'finite_t_susceptibility_hits': 489, 'finite_t_susceptibility_misses': 377, 'finite_t_susceptibility_currsize': 377, 'finite_t_susceptibility_maxsize': 512}**
...
|---|---|---|---|---:|---:|---:|---:|
| Finite-T STLS (experimental) | valid | finite_t_stls | benchmark_dense | 0.207 | 7 | 2.307 | 2.526 |
...
| model | status | backend | collision | runtime mean [s] | valid points | MAE [eV] | RMSE [eV] |
|---|---|---|---|---:|---:|---:|---:|
| RPA + static LFC | valid | classical_maxwellian | benchmark_dense | 0.012 | 5 | 2.277 | 2.857 |
| Finite-T STLS (experimental) | valid | finite_t_stls | collisionless_stls | 0.616 | 5 | 3.640 | 3.745 |
| RPA | valid | classical_maxwellian | benchmark_dense | 0.314 | 5 | 3.683 | 4.682 |
| Quantum hydrodynamic (experimental) | valid | quantum_hydrodynamic | benchmark_dense | 0.014 | 5 | 6.709 | 7.793 |
...
- `outputs\validation_outputs\plasmon_article_native_observable_experiment\minimal_xrts\all_model_results.json`
- `outputs\validation_outputs\plasmon_article_native_observable_experiment\minimal_xrts\benchmark_points.csv`
- `outputs\validation_outputs\plasmon_article_native_observable_experiment\minimal_xrts\benchmark_summary.csv`
- `outputs\validation_outputs\plasmon_article_native_observable_experiment\minimal_xrts\policy_state_summary.csv`
- `outputs\validation_outputs\plasmon_article_native_observable_experiment\minimal_xrts\policy_sensitivity_summary.csv`
- `outputs\validation_outputs\plasmon_article_native_observable_experiment\minimal_xrts\reconciliation_summary.csv`
- `outputs\validation_outputs\plasmon_article_native_observable_experiment\minimal_xrts\driven_policy_table.csv`
- `outputs\validation_outputs\plasmon_article_native_observable_experiment\minimal_xrts\driven_state_comparison.csv`
- `outputs\validation_outputs\plasmon_article_native_observable_experiment\minimal_xrts\driven_branch_reconciliation_delta.csv`
- `outputs\validation_outputs\plasmon_article_native_observable_experiment\minimal_xrts\ambient_dataset_overlay.png`
- `outputs\validation_outputs\plasmon_article_native_observable_experiment\minimal_xrts\driven_legacy_hydro_overlay.png`
- `outputs\validation_outputs\plasmon_article_native_observable_experiment\minimal_xrts\driven_best_hydro_overlay.png`
- `outputs\validation_outputs\plasmon_article_native_observable_experiment\minimal_xrts\driven_dataset_overlay.png`
- `outputs\validation_outputs\plasmon_article_native_observable_experiment\minimal_xrts\ambient_representative_spectra.png`
- `outputs\validation_outputs\plasmon_article_native_observable_experiment\minimal_xrts\driven_representative_spectra.png`