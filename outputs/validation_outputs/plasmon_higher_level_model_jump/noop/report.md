...
|---|---|---|---|---:|---:|---:|---:|
| Finite-T Lindhard | valid | finite_t_lindhard | benchmark_dense | 0.154 | 7 | 3.485 | 3.765 |
| RPA + static LFC | valid | classical_maxwellian | benchmark_dense | 0.064 | 7 | 4.502 | 5.365 |
| Mermin + static LFC | valid | classical_maxwellian | benchmark_dense | 0.059 | 7 | 4.503 | 5.366 |
...
| Finite-T Lindhard + static LFC | valid | finite_t_lindhard | benchmark_dense | 0.067 | 7 | 5.482 | 6.023 |
| RPA | valid | classical_maxwellian | benchmark_dense | 0.131 | 7 | 6.480 | 7.505 |
| Mermin | valid | classical_maxwellian | benchmark_dense | 0.133 | 7 | 6.482 | 7.506 |
| Quick look | not_applicable | classical_maxwellian | benchmark_dense | 0.048 | 7 | 6.528 | 7.560 |
...
| Finite-T Lindhard + Mermin + static LFC | valid | finite_t_lindhard | benchmark_dense | 0.006 | 5 | 7.294 | 8.213 |
...
- `C:\Users\dimab\Documents\Helios_parser\outputs\validation_outputs\plasmon_higher_level_model_jump\noop\all_model_results.json`
