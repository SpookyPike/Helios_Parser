...
|---|---|---|---|---:|---:|---:|---:|
| Finite-T Lindhard | valid | finite_t_lindhard | benchmark_dense | 0.315 | 7 | 3.485 | 3.765 |
| RPA + static LFC | valid | classical_maxwellian | benchmark_dense | 0.121 | 7 | 4.502 | 5.365 |
| Mermin + static LFC | valid | classical_maxwellian | benchmark_dense | 0.111 | 7 | 4.503 | 5.366 |
| Auto best per state | valid | classical_maxwellian | benchmark_dense | 0.134 | 7 | 4.503 | 5.366 |
| Finite-T Lindhard + Mermin | valid | finite_t_lindhard | benchmark_dense | 0.303 | 7 | 4.647 | 5.348 |
| Finite-T Lindhard + static LFC | valid | finite_t_lindhard | benchmark_dense | 0.114 | 7 | 5.482 | 6.023 |
| RPA | valid | classical_maxwellian | benchmark_dense | 0.254 | 7 | 6.480 | 7.505 |
| Mermin | valid | classical_maxwellian | benchmark_dense | 0.231 | 7 | 6.482 | 7.506 |
| Quick look | not_applicable | classical_maxwellian | benchmark_dense | 0.081 | 7 | 6.528 | 7.560 |
| Finite-T Lindhard + Mermin + static LFC | valid | finite_t_lindhard | benchmark_dense | 0.124 | 7 | 7.215 | 8.866 |

### Driven article-reconciled state vs experiment

| model | status | backend | collision | runtime mean [s] | valid points | MAE [eV] | RMSE [eV] |
|---|---|---|---|---:|---:|---:|---:|
| RPA + static LFC | valid | classical_maxwellian | benchmark_dense | 0.013 | 5 | 2.302 | 2.885 |
| Mermin + static LFC | valid | classical_maxwellian | benchmark_dense | 0.017 | 5 | 2.306 | 2.892 |
| Auto best per state | valid | classical_maxwellian | benchmark_dense | 0.018 | 5 | 2.306 | 2.892 |
| RPA | valid | classical_maxwellian | benchmark_dense | 0.560 | 5 | 3.713 | 4.735 |
| Mermin | valid | classical_maxwellian | benchmark_dense | 0.531 | 5 | 3.721 | 4.748 |
| Finite-T Lindhard | valid | finite_t_lindhard | benchmark_dense | 0.735 | 5 | 6.732 | 7.136 |
| Finite-T Lindhard + Mermin | valid | finite_t_lindhard | benchmark_dense | 0.731 | 5 | 7.448 | 8.301 |
| Finite-T Lindhard + static LFC | valid | finite_t_lindhard | benchmark_dense | 0.010 | 5 | 7.646 | 7.997 |
| Finite-T Lindhard + Mermin + static LFC | valid | finite_t_lindhard | benchmark_dense | 0.010 | 5 | 8.196 | 8.833 |
...
- `C:\Users\dimab\Documents\Helios_parser\outputs\validation_outputs\plasmon_higher_level_model_jump\response_function_ensemble_experimental\all_model_results.json`
- `C:\Users\dimab\Documents\Helios_parser\outputs\validation_outputs\plasmon_higher_level_model_jump\response_function_ensemble_experimental\benchmark_points.csv`
- `C:\Users\dimab\Documents\Helios_parser\outputs\validation_outputs\plasmon_higher_level_model_jump\response_function_ensemble_experimental\benchmark_summary.csv`
- `C:\Users\dimab\Documents\Helios_parser\outputs\validation_outputs\plasmon_higher_level_model_jump\response_function_ensemble_experimental\policy_state_summary.csv`
- `C:\Users\dimab\Documents\Helios_parser\outputs\validation_outputs\plasmon_higher_level_model_jump\response_function_ensemble_experimental\policy_sensitivity_summary.csv`
- `C:\Users\dimab\Documents\Helios_parser\outputs\validation_outputs\plasmon_higher_level_model_jump\response_function_ensemble_experimental\reconciliation_summary.csv`
- `C:\Users\dimab\Documents\Helios_parser\outputs\validation_outputs\plasmon_higher_level_model_jump\response_function_ensemble_experimental\driven_policy_table.csv`
- `C:\Users\dimab\Documents\Helios_parser\outputs\validation_outputs\plasmon_higher_level_model_jump\response_function_ensemble_experimental\driven_state_comparison.csv`
- `C:\Users\dimab\Documents\Helios_parser\outputs\validation_outputs\plasmon_higher_level_model_jump\response_function_ensemble_experimental\driven_branch_reconciliation_delta.csv`
- `C:\Users\dimab\Documents\Helios_parser\outputs\validation_outputs\plasmon_higher_level_model_jump\response_function_ensemble_experimental\ambient_dataset_overlay.png`
- `C:\Users\dimab\Documents\Helios_parser\outputs\validation_outputs\plasmon_higher_level_model_jump\response_function_ensemble_experimental\driven_legacy_hydro_overlay.png`
- `C:\Users\dimab\Documents\Helios_parser\outputs\validation_outputs\plasmon_higher_level_model_jump\response_function_ensemble_experimental\driven_best_hydro_overlay.png`
- `C:\Users\dimab\Documents\Helios_parser\outputs\validation_outputs\plasmon_higher_level_model_jump\response_function_ensemble_experimental\driven_dataset_overlay.png`
- `C:\Users\dimab\Documents\Helios_parser\outputs\validation_outputs\plasmon_higher_level_model_jump\response_function_ensemble_experimental\ambient_representative_spectra.png`
- `C:\Users\dimab\Documents\Helios_parser\outputs\validation_outputs\plasmon_higher_level_model_jump\response_function_ensemble_experimental\driven_representative_spectra.png`