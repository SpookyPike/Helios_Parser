...
|---|---|---|---|---:|---:|---:|---:|
| Finite-T STLS (experimental) | valid | finite_t_stls | benchmark_dense | 0.226 | 7 | 2.307 | 2.526 |
| Quantum hydrodynamic (experimental) | valid | quantum_hydrodynamic | benchmark_dense | 0.073 | 7 | 3.950 | 5.865 |
| RPA + static LFC | valid | classical_maxwellian | benchmark_dense | 0.064 | 7 | 4.502 | 5.365 |
| RPA | valid | classical_maxwellian | benchmark_dense | 0.115 | 7 | 6.480 | 7.505 |
...
| Finite-T STLS (experimental) | valid | finite_t_stls | collisionless_stls | 0.656 | 5 | 3.618 | 3.721 |
| RPA | valid | classical_maxwellian | benchmark_dense | 0.264 | 5 | 3.692 | 4.695 |
...
- `outputs\validation_outputs\plasmon_stls_backend_experiment\benchmark_points.csv`
- `outputs\validation_outputs\plasmon_stls_backend_experiment\benchmark_summary.csv`
- `outputs\validation_outputs\plasmon_stls_backend_experiment\policy_state_summary.csv`
- `outputs\validation_outputs\plasmon_stls_backend_experiment\policy_sensitivity_summary.csv`
- `outputs\validation_outputs\plasmon_stls_backend_experiment\reconciliation_summary.csv`
- `outputs\validation_outputs\plasmon_stls_backend_experiment\driven_policy_table.csv`
- `outputs\validation_outputs\plasmon_stls_backend_experiment\driven_state_comparison.csv`
- `outputs\validation_outputs\plasmon_stls_backend_experiment\driven_branch_reconciliation_delta.csv`
- `outputs\validation_outputs\plasmon_stls_backend_experiment\ambient_dataset_overlay.png`
- `outputs\validation_outputs\plasmon_stls_backend_experiment\driven_legacy_hydro_overlay.png`
- `outputs\validation_outputs\plasmon_stls_backend_experiment\driven_best_hydro_overlay.png`
- `outputs\validation_outputs\plasmon_stls_backend_experiment\driven_dataset_overlay.png`
- `outputs\validation_outputs\plasmon_stls_backend_experiment\ambient_representative_spectra.png`
- `outputs\validation_outputs\plasmon_stls_backend_experiment\driven_representative_spectra.png`