...
|---|---|---|---|---:|---:|---:|---:|
| Finite-T Lindhard | valid | finite_t_lindhard | benchmark_dense | 0.170 | 7 | 3.485 | 3.765 |
...
| Finite-T Lindhard + static LFC | valid | finite_t_lindhard | benchmark_dense | 0.058 | 7 | 5.482 | 6.023 |
| RPA | valid | classical_maxwellian | benchmark_dense | 0.141 | 7 | 6.480 | 7.505 |
...
| model | status | backend | collision | runtime mean [s] | valid points | MAE [eV] | RMSE [eV] |
|---|---|---|---|---:|---:|---:|---:|
| RPA + static LFC | valid | classical_maxwellian | benchmark_dense | 0.005 | 5 | 2.288 | 2.868 |
| Auto best per state | valid | classical_maxwellian | benchmark_dense | 0.008 | 5 | 2.293 | 2.877 |
| Mermin + static LFC | valid | classical_maxwellian | benchmark_dense | 0.008 | 5 | 2.293 | 2.877 |
| RPA | valid | classical_maxwellian | benchmark_dense | 0.285 | 5 | 3.692 | 4.695 |
| Mermin | valid | classical_maxwellian | benchmark_dense | 0.285 | 5 | 3.702 | 4.719 |
| Finite-T Lindhard | valid | finite_t_lindhard | benchmark_dense | 0.428 | 5 | 6.804 | 7.228 |
| Finite-T Lindhard + Mermin | valid | finite_t_lindhard | benchmark_dense | 0.391 | 5 | 7.443 | 8.294 |
...
- `outputs\validation_outputs\plasmon_article_cases_driven_increment_pass\all_model_results.json`
- `outputs\validation_outputs\plasmon_article_cases_driven_increment_pass\benchmark_points.csv`
- `outputs\validation_outputs\plasmon_article_cases_driven_increment_pass\benchmark_summary.csv`
- `outputs\validation_outputs\plasmon_article_cases_driven_increment_pass\policy_state_summary.csv`
- `outputs\validation_outputs\plasmon_article_cases_driven_increment_pass\policy_sensitivity_summary.csv`
- `outputs\validation_outputs\plasmon_article_cases_driven_increment_pass\reconciliation_summary.csv`
- `outputs\validation_outputs\plasmon_article_cases_driven_increment_pass\driven_policy_table.csv`
- `outputs\validation_outputs\plasmon_article_cases_driven_increment_pass\driven_state_comparison.csv`
- `outputs\validation_outputs\plasmon_article_cases_driven_increment_pass\driven_branch_reconciliation_delta.csv`
- `outputs\validation_outputs\plasmon_article_cases_driven_increment_pass\ambient_dataset_overlay.png`
- `outputs\validation_outputs\plasmon_article_cases_driven_increment_pass\driven_legacy_hydro_overlay.png`
- `outputs\validation_outputs\plasmon_article_cases_driven_increment_pass\driven_best_hydro_overlay.png`
- `outputs\validation_outputs\plasmon_article_cases_driven_increment_pass\driven_dataset_overlay.png`
- `outputs\validation_outputs\plasmon_article_cases_driven_increment_pass\ambient_representative_spectra.png`
- `outputs\validation_outputs\plasmon_article_cases_driven_increment_pass\driven_representative_spectra.png`